# Vanilla JS Pokédex
![Pokédex from the Kanto region](/images/pokedex.png)
*Picture from PNG Mart [https://www.pngmart.com/image/764108](https://www.pngmart.com/image/764108) *
...
- Document Fragments
- JSON
- Event Listeners (Event Delegation used for performance and clean code)
- Loops (for, for...in, for...of, forEach())
- Higher Order Functions (extensive use of the map() and filter() methods)
- DOM Manipulation
